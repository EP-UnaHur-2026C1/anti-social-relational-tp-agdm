...
const { validarPostConComentarios } = require('../middlewares/validarPostConComentarios.js');

router.post('/', crearComentarioConValidacion, crearComentario);
router.get('/post/:id', validarIdPost, validarPostConComentarios, obtenerComentarios);
